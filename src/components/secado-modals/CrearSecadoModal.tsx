...
import type { CreateSecadoDTO } from "../../api/secado.api";
...
export default function CrearSecadoModal({ open, onClose, onSubmit, lotes, loading }: Props) {
  ...
  // Filtrar y ordenar lotes: Lotes en estado EN_PROCESO primero
      ...
      <Form form={form} layout="vertical" onFinish={handleFinish} initialValues={{ fechaInicio: dayjs() }}>
        ...
        <Row gutter={16}>
          <Col span={12}>
            ...
            >
              <InputNumber style={{ width: "100%" }} min={0.1} precision={2} placeholder="Ej. 500" addonAfter="kg" />
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item
            ...
            >
              <InputNumber style={{ width: "100%" }} min={0} precision={2} placeholder="Ej. 420" addonAfter="kg" />
            </Form.Item>
          </Col>
        </Row>
